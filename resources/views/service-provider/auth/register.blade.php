            ...
            <div class="row w-100">
                <div class="col-lg-8 mx-auto">
                    <div class="auth-form-light text-left p-5">
                        ...
                        <form method="POST" action="{{ route('provider.auth.register') }}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-lg-5">
                                    <input id="name" type="text"
                                           ...
                                           name="self_description" value="{{ old('self_description') }}" required
                                ...
                                <div class="form-group col-lg-5">
                                    <input id="name" type="text"
                                           ...
                                           name="skill_description" value="{{ old('skill_description') }}" required
                                           autocomplete="name" autofocus>
