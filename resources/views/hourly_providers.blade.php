                ...
                >
                    <div class="h_gallery_item">
                        <div class="g_img_item">
                            ...
                            @endisset
                            <a class="light" href="{{ asset("storage/".$category->image) }}"><img
                        ...
                        <div class="g_item_text">
                            ...
                            <p>{{ $category->price_for_hour .' '. optional($category->currency)->sign }}/hr</p>
                            ...
                            <br/>
                            <br/>
                            <a href="{{ route("provider-profile",$category->serId) }}"
