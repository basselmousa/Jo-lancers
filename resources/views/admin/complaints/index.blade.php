                                ...
                                <tr>
                                    ...
                                    @if($skill->actioned == 0)
                                        <td>
                                            ...
                                            document.getElementById('action-complaint-{{$skill->id}}').submit();
                                            ">Action</button>
                                            <form class="d-none" id="action-complaint-{{$skill->id}}" method="post" action="{{ route("admin.complaint.create",$skill->id) }}">
                                                @csrf
                                            </form>
                                        </td>
