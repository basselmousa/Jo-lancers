...
{{--                            </div>--}}
                          ...
                          <span class="float-left">
                            ...
                            {{ auth("web")->user()->is_active ? 'Active' : "disabled" }}
                          </span>
                                </p>
                                {{--                                <p class="clearfix">--}}
                                {{--                          <span class="float-left">--}}
                          ...
                          <span class="float-left">
                            Skill Description
                                    ...
                                    <span class="float-right text-muted">
                                        {{ auth("web")->user()->skill_description }}
                        ...
                        <div class="col-lg-8 pl-lg-5">
                            <div class="d-flex justify-content-between">
                                <div>
                                    <h3>{{ auth("web")->user()->full_name }}</h3>
                                    <div class="d-flex align-items-center">
                                        <h5 class="mb-0 mr-2 text-muted">{{ auth("web")->user()->country }}</h5>
...
{{--                                        </div>--}}
                            ...
                            <div class="profile-feed">
                                <form method="POST" action="{{ route('user.profile.updateProfile') }}"
                                    ...
                                    <div class="row">
                                        <div class="form-group col-lg-5">
                                            <input id="name" type="text"
                                                   ...
                                                   name="first_name"
                                                   value="{{ old('first_name') ?? explode(" ",auth("web")->user()->full_name)[0]  }}"
                                                   required
                                        ...
                                        <div class="form-group col-lg-5">
                                            <input id="name" type="text"
                                                   ...
                                                   name="second_name"
                                                   value="{{ old('second_name') ?? explode(" ",auth("web")->user()->full_name)[1] }}"
                                                   required
                                        ...
                                        <div class="form-group  col-lg-5">
                                            <input id="name" type="text"
                                                   ...
                                                   name="last_name"
                                                   value="{{ old('last_name') ?? explode(" ",auth("web")->user()->full_name)[2] }}"
                                        ...
                                        <div class="form-group  col-lg-5">
                                            <input id="name" type="text"
                                                   ...
                                                   name="username"
                                                   value="{{ old('username') ?? auth("web")->user()->username  }}"
                                        ...
                                        <div class="form-group col-lg-5">
                                            ...
                                            <select class="form-control" name="city">
                                                ...
                                                @foreach(\App\Http\Controllers\Cities::$cities as $city)
                                                    <option
                                                        value="{{ $city }}" {{ (old("city") ?? auth("web")->user()->city) == $city ? 'selected' : '' }}>{{ $city }}</option>
                                        ...
                                        <div class="form-group col-lg-5">
                                            <input id="name" type="text"
                                                   ...
                                                   name="state"
                                                   value="{{ old('state') ?? auth("web")->user()->state }}"
                                        ...
                                        <div class="form-group col-lg-5">
                                            <input id="name" type="text"
                                                   ...
                                                   name="zip_code"
                                                   value="{{ old('zip_code') ?? auth("web")->user()->zip_code }}"
                                                   required autocomplete="name"
                                                   autofocus>
                                        ...
                                        <div class="form-group col-lg-5">
                                            <input id="email" type="date"
                                                   ...
                                                   name="birthdate"
                                                   value="{{ old('birthdate') ??  auth("web")->user()->birthdate   }}"
                                                   required
                                                   autocomplete="email">
